<div>
    @if($updateMode)
        @include('tipocontrato.tipocon_update')
    @else
        @include('tipocontrato.tipocon_create')
    @endif
      ...
      <table class="table table-sm col-6">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="col-3">{{ $item->nombretipo }}</td>
              <td class="col-2">
                <button wire:click="edit({{ $item->id }})" class="btn bg-transparent color" title="Editar"><svg fill="none" width="15" height="15" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></button>
