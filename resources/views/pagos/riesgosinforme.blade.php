...
<div class="row">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-8">
                <div class="card">
                <h5 class="card-header">Listado Riesgos Pago No {{$pago->id}} - Contrato: {{$pago->contrato->numcontrato}} </h5>
                  <div class="card-body">
                                                    ...
                                                    <div class="modal fade" id="edit{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <h5 class="modal-title" id="exampleModalLabel">Actualizar Riesgos  pago No {{$pago->id}}</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form action="{{ route('riesgocon', $item->id)}}" method="POST">
                                                                           @csrf
